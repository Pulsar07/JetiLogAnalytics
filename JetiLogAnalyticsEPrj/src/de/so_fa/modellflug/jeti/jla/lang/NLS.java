...
public class NLS {
  ...
  public static enum NLSKey {
	CO_KEY_READLOG, CO_SCAN_LOG, CO_FLIGHT_COUNT, CO_MODEL, CO_MODELS, CO_STATISTIC_TOTAL, CO_FLIGHT, CO_FLIGHTS,
	CO_FLIGHT_DETECTION_TYPE, CO_FLIGHTDURATION, CO_FLIGHT_MINMAX, CO_LOG_COUNT, CO_TOTAL, CO_LOGDURATION,
	CO_MODEL_COUNT, CO_LOG_FOLDER_NOT_AS_EXPECTED, CO_LOG_FILE_NOT_AS_EXPECTED, CO_MODEL_STATISTIC, CO_ALARMS,
	CO_DEVICES, CO_LOG_FILE, CO_SIG_DURA, CO_GEN_SPEED, CO_GEN_AIR_SPEED, CO_GEN_GPS_SPEED, CO_GEN_DISTANCE,
	CO_GEN_HEIGHT, CO_GEN_MIN, CO_GEN_MAX, CO_GEN_AVG, CO_GEN_VOLTAGE, FX_HelpHeader, FX_HelpContent, FX_StartAnalysis,
	FX_StopAnalysis, CO_ANALYSIS_STOPPED, CO_GEN_INHOURS, CO_GEN_TIME_RANGE, CO_GEN_PER_WEEK, CO_GEN_PER_DAY,
	CO_GEN_PER_MONTH, CO_GEN_PER_YEAR, FX_Deidentification
  }
